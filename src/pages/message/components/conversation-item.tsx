  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start justify-center gap-1">
        <Typography
          level="base2sm"
          className="text-white mr-6 flex flex-row-reverse items-center gap-2"
        >
        ...
        <Typography
          level="captionr"
          className="text-tertiary col-span-2 opacity-80 mr-6 line-clamp-1 group-hover:text-white"
        >
